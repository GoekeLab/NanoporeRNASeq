...
bamFiles <- Rsamtools::BamFileList(NanoporeData[["EH3808"]], NanoporeData[["EH3809"]],NanoporeData[["EH3810"]], NanoporeData[["EH3811"]], NanoporeData[["EH3812"]], NanoporeData[["EH3813"]])
```
...
# usage
packages <- c("ggbio", "circlize", "ComplexHeatmap","apeglm","rlang","GenomicAlignments")
ipak(packages)
```
