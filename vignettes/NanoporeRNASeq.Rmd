...
### Run bambu
```{r}
se <- bambu(reads = readlist, annotations = annotation, genomeSequence = "BSgenome.Hsapiens.NCBI.GRCh38", extendAnnotations = TRUE, verbose = FALSE, ncore = 1)
se
```
...
plot.bambu(se, type = "annotation", gene_id = unique(rowData(seExtended)$GENEID)[10])
```
